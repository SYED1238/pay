...
import { PaymentStatus, UPIApp, Transaction, DeviceInfo } from '@/lib/types';
import {
  validateAmount,
  formatAmount,
  detectDevice,
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          boxShadow: '0 0 80px -20px rgba(201, 169, 110, 0.06), 0 25px 50px -12px rgba(0, 0, 0, 0.5)',
        }}
      >
        {/* Header */}
        <div className="px-6 pt-6 pb-4">
          ...
          {/* Divider */}
          <div className="mt-4 h-[1px]" style={{ backgroundColor: 'var(--border-subtle)' }} />
        </div>
          ...
          <AnimatePresence mode="wait">
              ...
              >
                ...
                <motion.button
                  ...
                  style={{
                    ...
                    color: isValid ? '#080808' : 'var(--text-tertiary)',
            ...
            {step === 'method' && (
              ...
              >
                ...
                {/* ══════════════════════════════════════════════════════
                    MOBILE FLOW: UPI APP-FIRST EXPERIENCE
                   ══════════════════════════════════════════════════════ */}
                {device.isMobile ? (
                    ...
                    <div>
                      <motion.button
                        ...
                        style={{
                          ...
                          color: '#080808',
                          boxShadow: '0 4px 24px -4px rgba(201, 169, 110, 0.35)',
                        }}
                      >
                        {/* UPI Arrow Icon */}
                  ...
                  /* ══════════════════════════════════════════════════════
                      DESKTOP FLOW: QR-FIRST EXPERIENCE
                     ══════════════════════════════════════════════════════ */
                  <div className="space-y-4">
                    <div className="text-center">
            ...
            {step === 'processing' && (
              <motion.div
                ...
                transition={{ duration: 0.3, ease: [0.16, 1, 0.3, 1] }}
              >
                {/* Desktop: if pending, can show QR + status */}
